    ...
    <div>
          ...
          <div class='container max-width-sm'>
                ...
                <div class="author bg-contrast-lower padding-md margin-top-md margin-bottom-xl">
                        ...
                        <a href="#0" class="author__img-wrapper">
                          <img src="/img/maisie.png" alt="Author picture">
                        </a>
          ...
          <div class='container max-width-lg'>
            ...
            <div class="grid grid-gap-md items-center">
                <div class="col-6@md">
                    <a href="#0" class="story__category margin-x-sm margin-bottom-sm">
                               
                            <i>科目1</i>
                     </a>
                     <a href="#0" class="story__category margin-x-sm margin-bottom-sm thebgwhite">
                     ...
                     <a href="#0" class="story__category margin-x-sm margin-bottom-sm thebgwhite">
                            ...
                            <i>科目1</i>
                     </a>                     <a href="#0" class="story__category margin-bottom-sm margin-x-sm thebgwhite">
