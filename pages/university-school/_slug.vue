                    ...
                    <div class="grid grid-gap-md">
                      <div class="col-8@md">
                            ...
                            <div>
                              ...
                              <img class='floatl margin-right-md' :src="backendurl + article.image.url" height="80">
                              <h4 class="color-primary floath"><span class="padding-left-xxxs"></span>{{ article.name }}</span></h4>
                            </div>
                            <div style="clear:both"></div>
                          
                            
                            <div class="author bg-contrast-lower padding-md margin-y-md">
...
Or Any special A Level subject that other school doesn’t offer
                      ...
                      <div class="col-4@md">
                            <a href="#0" class="margin-top-lg width-100% btn btn--accent padding-y-sm">立即報名</a>
